...
gmsh.option.setNumber("Mesh.CharacteristicLengthMin", 0.5e-3)  # Minimum element size
gmsh.option.setNumber("Mesh.CharacteristicLengthMax", 0.5e-3)  # Maximum element size
